                ...
                <tbody>
                    ...
                    <?php foreach ($menu as $m) : ?>
                        <tr align="center">
                            ...
                            <td><?= $m['menu']; ?></td>
                            <td>
                                <a href="<?= base_url('menu/edit/') . $m['id']; ?>" class="badge badge-primary">edit</a>
                                <a href="<?= base_url('menu/hapus/') . $m['id']; ?>" onclick="return confirm('Are you sure you want to delete this data?');" class="badge badge-danger">delete</a>
                            </td>
                        </tr>
                        <?php $i++; ?>
                    <?php endforeach; ?>
